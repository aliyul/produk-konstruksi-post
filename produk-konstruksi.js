...
const urlMappingProdukAlatKonstruksi = {
  "https://www.betonjayareadymix.com/p/jual-alat-konstruksi-ringan.html": "Jual Alat Konstruksi Ringan",  // TYPE: MONEY_MASTER
  "https://www.betonjayareadymix.com/p/jual-alat-berat.html": "Jual Alat Berat",  // TYPE: MONEY_MASTER
  "https://www.betonjayareadymix.com/p/jual-alat-berat-tambang.html": "Jual Alat Berat Tambang"  // TYPE: MONEY_MASTER
};
...
function generateBreadcrumbForMapping(mappingObj, currentUrl, breadcrumbNames = [], pillarType = 'JASA_KONSTRUKSI') {
    ...
    console.log(`📊 ========================================`);
    console.log(`📊 Breadcrumb Generator`);
    ...
    if (allLevels.length > 0) {
        const parentTerdekat = allLevels[allLevels.length - 1];
    ...
    // Inject JSON-LD (FORMAT MINIFIED - TANPA SPASI)
    ...
    });  // ← MINIFIED, tanpa spasi/indentasi
    ...
    if (!urlMappingGabungan[cleanUrlProdukKons]) {
	 ...
	 (async function runHybridDateModified() {
		  try {
		    ...
		    await loadEvergreenScript("2026-01-10T10:30:00+07:00");
